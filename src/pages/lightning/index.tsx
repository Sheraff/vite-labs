...
function animate(ctx: CanvasRenderingContext2D) {
	...
	const arc = makeArc([width / 4, height / 2], [(3 * width) / 4, (3 * height) / 4])
	const arcBlue = makeArc([width / 4, height / 2], [(3 * width) / 4, (3 * height) / 4], {
		color: "deepskyblue",
		impulseRange: [300, 500],
		normalRange: 15,
		width: 4,
	})

	const arc2 = makeArc([200, 400], [1000, 400], { color: "red" })

	const arc3 = makeArc([200, 400], [1000, 400], { color: "limegreen", impulseRange: [200, 400] })
	const arc4 = makeArc([200, 600], [1000, 600], { color: "purple", impulseRange: [20, 50] })
