...
export default function TinkerbellMap() {
	...
	useEffect(() => {
		...
		preset1Button.addEventListener(
			"click",
			() => {
		...
		preset2Button.addEventListener(
			"click",
			() => {
				const a = form.elements.namedItem("a") as HTMLInputElement
				a.value = "0.3"
		...
		<main className={styles.main}>
			...
			<form ref={formRef}>
				<fieldset>
					...
					<button type="button" id="random" name="random">
						Randomize
					</button>
					<button type="button" id="preset-1" name="preset-1">
						Preset 1
					</button>
					<button type="button" id="preset-2" name="preset-2">
						Preset 2
					</button>
				</fieldset>
			</form>
