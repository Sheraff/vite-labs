...
const SERIES = {
	"A7 Chord": [440.0, 523.25, 659.26, 783.99],
	"C Major Chord": [261.63, 329.63, 392.0],
	"C Minor Chord": [261.63, 311.13, 392.0],
	"E pentatonic": [329.63, 369.99, 415.3, 493.88, 554.37, 659.26],
	"D octaves": [18.35, 36.71, 73.42, 146.83, 293.66, 587.33, 1174.66, 2349.32, 4698.64],
	"G7 (orchestral)": [98.0, 293.66, 493.88, 698.46],
	...
	"Very Square Wave": [
		...
		4100, 4300, 4500, 4700, 4900, 5100, 5300, 5500, 5700, 5900, 6100, 6300, 6500, 6700, 6900, 7100, 7300, 7500,
	],
}
